...
echo Compiling Darkstone PC Randomizer + MTF Explorer (JavaFX)...
echo Compiling Darkstone PC Randomizer + MTF Explorer (JavaFX)... > "%LOG%"
...
javac --release 21 -encoding UTF-8 ^
  ...
  src\com\serifsystemworks\darkstone\mtf\*.java ^
  src\com\serifsystemworks\darkstone\pc\*.java ^
  src\com\serifsystemworks\darkstone\ui\PcMainView.java ^
  src\com\serifsystemworks\darkstone\ui\MtfExplorerView.java ^
  src\com\serifsystemworks\darkstone\DarkstonePcApp.java ^
  src\com\serifsystemworks\darkstone\MtfExplorerApp.java ^
  1>>"%LOG%" 2>>&1
